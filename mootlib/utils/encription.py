"""Utilities for encrypting and decrypting CSV files securely using Fernet encryption."""
...
def get_encryption_key() -> bytes:
    ...
    if key := os.getenv("MOOTLIB_ENCRYPTION_KEY"):
        return key.encode()
    raise ValueError(
        "MOOTLIB_ENCRYPTION_KEY environment variable not set. Generate a key using: "
...
if __name__ == "__main__":
    ...
    print("\nGenerated new encryption key. Set this in your GitHub secrets as MOOTLIB_ENCRYPTION_KEY:")
    print(f"\n{key.decode()}\n")
